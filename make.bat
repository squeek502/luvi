...
COPY build\Release\luvi_renamed.lib luvi_renamed-tiny-Windows-amd64.lib
GOTO :end

:artifacts-tiny32
IF NOT EXISTS artifacts MKDIR artifacts
COPY build\Release\luvi.exe luvi-tiny-Windows-ia32.exe
COPY build\Release\luvi.lib luvi-tiny-Windows-ia32.lib
COPY build\Release\luvi_renamed.lib luvi_renamed-tiny-Windows-ia32.lib
GOTO :end

:artifacts-regular
:artifacts-regular-asm
IF NOT EXISTS artifacts MKDIR artifacts
COPY build\Release\luvi.exe luvi-regular-Windows-amd64.exe
COPY build\Release\luvi.lib luvi-regular-Windows-amd64.lib
COPY build\Release\luvi_renamed.lib luvi_renamed-regular-Windows-amd64.lib
GOTO :end

:artifacts-regular32
:artifacts-regular32-asm
IF NOT EXISTS artifacts MKDIR artifacts
COPY build\Release\luvi.exe luvi-regular-Windows-ia32.exe
COPY build\Release\luvi.lib luvi-regular-Windows-ia32.lib
COPY build\Release\luvi_renamed.lib luvi_renamed-regular-Windows-ia32.lib
GOTO :end
